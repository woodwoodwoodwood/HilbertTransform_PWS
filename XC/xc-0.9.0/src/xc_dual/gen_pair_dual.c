...
// cmp 2 spec_path, extract date part, 2018.001.0000
...
// read each file's header and data into *pSpecArray
...
// only when head1 == head2 and filenameDate1 = filenameDate2, pair them 
